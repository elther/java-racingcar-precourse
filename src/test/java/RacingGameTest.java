...
import nextstep.domain.car.Cars;
import nextstep.domain.curcuit.Curcuit;
import nextstep.domain.curcuit.Round;
...
public class RacingGameTest {
    ...
    class Context_with_first_class_collection {
        ...
        void it_created_cars_save_first_class_collection(String str){
            ...
            assertThat(curcuit.getPlayers().getCars()).isInstanceOf(ArrayList.class);
